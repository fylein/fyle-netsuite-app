...
describe('Expense Field', () => {
    ...
    it('map expense field', () => {
        ...
        cy.getElement('netsuite-feild-data').eq(1).click().get('mat-option').contains('Department').click()
        cy.getElement('fyle-feild-data').eq(1).click().get('mat-option').contains('Project').click()
        ...
        cy.getElement('add-btn').contains('Add another field').click()
        cy.getElement('netsuite-feild-data').eq(2).click().get('mat-option').contains('Location').click()
