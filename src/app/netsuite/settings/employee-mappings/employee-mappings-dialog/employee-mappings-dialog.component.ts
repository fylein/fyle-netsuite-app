...
export class EmployeeMappingsDialogComponent implements OnInit {
  ...
  submit() {
    ...
    if (that.form.valid && (netsuiteVendor || netsuiteEmployee)) {
      ...
      if (creditCardAccount || that.generalSettings.corporate_credit_card_expenses_object !== 'BILL' && that.generalSettings.corporate_credit_card_expenses_object) {
  ...
  reset() {
    ...
    forkJoin([
      ...
      that.form = that.formBuilder.group({
        ...
        creditCardAccount: [defaultCCCObj || '', that.generalSettings.corporate_credit_card_expenses_object !== 'BILL' && that.generalSettings.corporate_credit_card_expenses_object ? that.forbiddenSelectionValidator(that.cccObjects) : null]
      });
